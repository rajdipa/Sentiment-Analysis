...
# Generate an output.csv file of predictions in the same directory.
...
def main():
    # Get train data.
    train_phrases = cleaning.read_data("../data/train.csv", "Phrase")
    train_labels = cleaning.read_data("../data/train.csv", "Sentiment")
    ...
    # Read in test data.
    test_phrases = cleaning.read_data("../data/testset_1.csv", "Phrase")
    test_ids = cleaning.read_data("../data/testset_1.csv", "PhraseId")
